...
RSV_NOT_MATCH = ({"message": "Request uuid not match."}, 890)
RSV_LIST_IS_EMPTY = ({"message": "Reservation list is empty."}, 891)
RSV_ALREADY_MADE = ({"message": "Reservation have already made."}, 892)
RSV_NOT_MADE = ({"message": "Reservation have not been made."}, 893)
RSV_REACH_LIMIT = ({"message": "Reservation reached number limit."}, 894)
